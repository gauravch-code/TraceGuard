...
type Result = { id: string; draft: string; status: "success" | "review"; policy: { windowDays: number; eligible: boolean; humanReviewRequired: boolean } };
